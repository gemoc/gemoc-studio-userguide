...
. it will also fork the current timeline and create a new branch of execution.

image:images/workbench/modeling/timeline/timeline_branch.png[Show caller]
...
A decorator is show on all element holding a breakpoint.
The decorator also reflect the state of the breakpoint:

- enabled

image:images/workbench/modeling/breakpoint_enabled.png[Show caller]

- disabled

image:images/workbench/modeling/breakpoint_disabled.png[Show caller]
...
image:images/workbench/modeling/execution_data_highlight.png[Show caller]
