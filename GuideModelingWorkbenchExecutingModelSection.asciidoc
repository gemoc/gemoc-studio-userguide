...
The Stimuli Manager view display the list of MSE has strong interactions with the Logical Steps view.

image:images/workbench/modeling/stimuliManager_view.png[Stimuli manager view]

When selecting an MSE you can choose its behavior by clicking on :

* Green down arrow : free tick for this MSE in the next LogicalStep
* Orange down arrow : forbid a tick for this MSE in the next LogicalStep
* Orange up : force a tick for this MSE in the next LogicalStep
