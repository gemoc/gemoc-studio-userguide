...
The DSE are defined using the *Gemoc Events Language* (GEL). Create a new file with extension ".GEL" in your DSE project.
...
Therefore, the first step to designing the DSE in GEL is importing the ECL file and the Ecore file of the xDSML.

Then, DSEs can be defined between the "DSE" and "end" keywords.
