...
image::images/gemoc_modeling_workbench_TFSM_animation_screenshot.png["Screenshot of GEMOC Studio Modeling Workbench on the TFSM example (execution and animation)", 800]
(((TFSM)))
