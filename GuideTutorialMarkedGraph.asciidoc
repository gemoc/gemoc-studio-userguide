...
.Create an xDSML Project
image::MarkedGraph/images/MG-SelectGemocLanguageProject.png[Create an xDSML Project, 800]
...
image::MarkedGraph/images/MG-SelectGemocLanguageProject-ProjectName.png[Define the name of the project, 800]

Click on __Next__  and define the name of the language (__markedgraph__).

.Define the name of the language
image::MarkedGraph/images/MG-SelectGemocLanguageProject-LanguageName.png[Define the name of the language, 800] 
...
image::MarkedGraph/images/MG-XDSML-content.png[Content of the xDSML Project, 800]
...
.The xDSML Editor
image::MarkedGraph/images/MG-XDSML-start.png[The xDSML Editor, 800]
...
image::MarkedGraph/images/MG-XDSML-EMF-Browse.png[Browse to select the AS project, 800]

Then, select the "Genmodel URI".

.Browse to select the genmodel resource
image::MarkedGraph/images/MG-XDSML-EMF-genmodel-browse.png[Browse to select the genmodel resource, 800]

Finally, select the "Root container model
element" thanks to the "Select" buttons.

.Browse to select the root container
image::MarkedGraph/images/MG-XDSML-EMF-root-browse.png[Browse to select the root container, 800]
...
image::MarkedGraph/images/MG-XDSML-CS-select.png[Select Sirius graphical editor, 800]
...
.Create a K3 Project
image::MarkedGraph/images/MG-K3-Create.png[Create a K3 Project, 800]
...
image::MarkedGraph/images/MG-K3-Defined.png[Definition of the DSA (ED and EF), 800]
...
image::MarkedGraph/images/MG-DSE-Create.png[Create a DSE Project, 800]
...
image::MarkedGraph/images/MG-DSE-Template.png[Template of the ECL file, 800]
...
image::MarkedGraph/images/MG-DSE-Defined.png[Definition of the DSE (events and constraints), 800]
...
image::MarkedGraph/images/MG-animation-wizard-launch.png[Create GEMOC debug representation wizard]

On the first screen of the wizad, select "Extends an existing diagram
description".

.Select "Extends an existing diagram description"
image::MarkedGraph/images/MG-animation-wizard-choose.png[Select "Extends an existing diagram description"]


Select the viewpoint to extend "MarkedGraph diagram".

.Select the viewpoint to extend
image::MarkedGraph/images/MG-animation-wizard-select-viewpoint.png[Select the viewpoint to extend]
...
image::MarkedGraph/images/MG-animation-wizard-set-names.png[Information of the animation viewpoint]
...
image::MarkedGraph/images/MG-run-EclipseApplicationConfig.png[Define the Marked Graph Modeling Workbench configuration]
...
image::MarkedGraph/images/MG-run-WikipediaConfig.png[Define the configuration to run the wikipedia example]
...
image::MarkedGraph/images/MG-run-start.png[The wikipedia model is just started]
...
image::MarkedGraph/images/MG-run-start-select.png[One logical step selected]
...
image::MarkedGraph/images/MG-run-init.png[Execute a logical step]


Then, we can select a new logical step (here we selected the the logical step which fires the t2 transition).

.Transition t1 fired
image::MarkedGraph/images/MG-run-t1-fired.png[Transition t1 fired]

.Transition t2 fired
image::MarkedGraph/images/MG-run-t2-fired.png[Transition t2 fired]

.Some logical steps later
image::MarkedGraph/images/MG-run-last.png[Some logical steps later]
