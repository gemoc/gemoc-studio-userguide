...
Replace the content of the ECL file with the following code (explanations
are given bellow):
...
* Rather than using CCSL syntax, it is possible to user constraint automata
