...
.Create an xDSML Project
image::MarkedGraph/images/MG-SelectGemocLanguageProject.png[Create an xDSML Project]
...
image::MarkedGraph/images/MG-SelectGemocLanguageProject-ProjectName.png[Define the name of the project]

Click on __Next__  and define the name of the language (__markedgraph__).

.Define the name of the language
image::MarkedGraph/images/MG-SelectGemocLanguageProject-LanguageName.png[Define the name of the language] 
...
image::MarkedGraph/images/MG-XDSML-content.png[Content of the xDSML Project]
...
.The xDSML Editor
image::MarkedGraph/images/MG-XDSML-start.png[The xDSML Editor]
...
image::MarkedGraph/images/MG-XDSML-EMF-browse.png[Browse to select the AS project]

Then, select the "Genmodel URI".

.Browse to select the genmodel resource
image::MarkedGraph/images/MG-XDSML-EMF-genmodel-browse.png[Browse to select the genmodel resource]

Finally, select the "Root container model
element" thanks to the "Select" buttons.

.Browse to select the root container
image::MarkedGraph/images/MG-XDSML-EMF-root-browse.png[Browse to select the root container]
...
image::MarkedGraph/images/MG-XDSML-CS-select.png[Select Sirius graphical editor]
...
.Create a K3 Project
image::MarkedGraph/images/MG-K3-Create.png[Create a K3 Project]
...
image::MarkedGraph/images/MG-K3-Defined.png[Definition of the DSA (ED and EF)]
...
image::MarkedGraph/images/MG-DSE-Create.png[Create a DSE Project]
...
image::MarkedGraph/images/MG-DSE-Template.png[Template of the ECL file]
...
image::MarkedGraph/images/MG-DSE-Defined.png[Definition of the DSE (events and constraints)]
...
* xDSML Editor: It is sometimes required to save the file (for example
when the AS has been selected in order to create the k3dsa project).
* ECL Editor: If Precedes is not found, quit Eclipse and launch it
again.  It should solve the problem!
