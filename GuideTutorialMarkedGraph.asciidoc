...
[source]
----
include::images/MarkedGraph/files/markedgraph.xtend[DSA defined using K3]
----
...
link:images/MarkedGraph/files/markedgraph.ecl[following code] (explanations on
this code are given bellow):

[source]
.The file markedgraph.ecl
----
include::images/MarkedGraph/files/markedgraph.ecl[Definition of the MoCC]
----
...
We can then define in this project the following link:images/MarkedGraph/files/markedgraph.ccslLib[markedgraph.ccslLib] file. TODO: To be corrected.

[source]
.The file markedgraph.ccslLib defining a MoCCML library
----
include::images/MarkedGraph/files/markedgraph.ccslLib[Definition of a MoCCML library]
----
...
----
include::images/MarkedGraph/files/markedgraph-library.ecl[Definition of the MoCC using a MoCCML library]
----
...
manual. TODO: provide the URL to it.

We first define the declaration of a relation (placeReadWriteDef).  Here after
...
----
include::images/MarkedGraph/files/markedgraph.moccml[Textual representation of the constraint automata]
----
