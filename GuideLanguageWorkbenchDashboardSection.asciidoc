...
image::images/workbench/language/dashboard/open_dashboard_menu.png[Dashboard menu, 800]
...
image::images/workbench/language/dashboard/projects_viewer.png[Projects viewer, 800]
