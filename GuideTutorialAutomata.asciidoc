...
[icon="t-icons/IconeGemocStudio_48x48x32.png"]
...
TODO: Vérifier si ce n'est pas fait lors de la création du projet K3
par le Wizard.
...
* TODO: Supprimer les import sur les aspects non utilisés
* Dans project.xdsml, vérifier que le QVT-o référencé est celui du
...
* Expliquer les automates en partant des exemples, pour éviter la
...
* Comment définir l'équivalent de --atribute tabsize=4 dans le
