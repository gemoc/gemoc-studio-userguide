...
[[figure-workbenches_global-picture]]
.Main activities offered by the GEMOC workbenches.
image:images/intro/GemocWorkbenchesGlobalPicture.png[Main activities offered by the GEMOC workbenches]
