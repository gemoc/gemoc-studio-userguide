...
Items or roles relative to the Language Workbench are identified with the following icon : image:images/icons/IconeGemocLanguage.png[50,50]

Items or roles relative to the Modeling Workbench are identified with the following icon : image:images/icons/IconeGemocModel.png[50,50]

TODO include figure here

=== Language Workbench overview image:images/icons/IconeGemocLanguage.png[30,30, role=right]
...
=== Modeling workbench overview image:images/icons/IconeGemocModel.png[30,30, role=right]
