...
Items or roles relative to this workbench are identified with the following icon : image:images/icons/IconeGemocLanguage.png[50,50]

To acheive that, it offers appropriate tools and guidance for the underlying activities wich are grouped in categories.

TODO: add icon of the workbench
...
Items or roles relative to this workbench are identified with the following icon : image:images/icons/IconeGemocModel.png[50,50]
