...
=== Language Workbench overview image:images/icons/IconeGemocLanguage_32.png[width=32, height=32, role=right]
...
=== Modeling workbench overview image:images/icons/IconeGemocModel_32.png[width=32, height=32, role=right]
