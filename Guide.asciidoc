...
[NOTE]
In order to improve run well, Eclipse workbench needs to run with additional memory. Use the following setting to start Eclipse: -Xms1024m -Xmx1024m -XX:PermSize=512m -XX:MaxPermSize=512m
